...
const meta: Meta<typeof CDashboardMenu> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'The DashboardMenu component is intended to be used inside the DashboardSidebar to provide the side menu for a dashboard layout.',
      },
    },
    layout: 'fullscreen',
  },
  render: (args) => ({
    ...
    setup() {
      ...
      return {
        args, userMenuOptions, sideMenuItems, handleOptionSelect,
      };
    },
    template: `
